...
export const FetchProductGazetteListService = (params: { limit: number; offset: number }) =>
...
export const FetchLabelPdfHistoryService = (params: { limit: number; offset: number }) =>
